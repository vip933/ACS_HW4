...
.task2:
    ...
    PrintContainer cont, [len], [ofst1]        ;error for in
    FileClose [ofst1]
...
.subNanoOnly:
    ...
    PrintStr "Average mean of all surface squares of all shapes = ", [stdout]
    ...
    PrintStr  "Average mean of all surface squares of all shapes = ", [ofst2]
